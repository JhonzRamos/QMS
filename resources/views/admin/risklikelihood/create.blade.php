...
@section('content')
 ...
 <div class="box box-primary ">
        ...
        <h3 class="box-title"><i class="fa fa-plus-circle fa-fw"></i>Add new Risk Likelihood</h3>
        </div>
        <div class="box-body">
         {!! Form::open(array('route' => 'admin'.'.risklikelihood.store', 'id' => 'form-with-validation')) !!}
